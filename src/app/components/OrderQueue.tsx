      ...
      <div className="inventory-list">
          <div className="inventory-item">
            <div className="product-info-container">
                <img src="../../../images/tshirt-black.svg" alt="Gildan T-Shirt - Red / M" />
          ...
          <div className="inventory-item">
            <div className="product-info-container">
                <img src="../../../images/tshirt-red.svg" alt="Gildan T-Shirt - Red / M" />
          ...
          <div className="inventory-item">
            <div className="product-info-container">
                <img src="../../../images/tshirt-white.svg" alt="Gildan T-Shirt - White / L" />
